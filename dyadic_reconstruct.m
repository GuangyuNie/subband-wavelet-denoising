function [Y] = dyadic_reconstruct(Y,h2,g2)
% Reconstruct
[rows,columns] = size(Y);

  row_offset = 0;
  column_offset = 0;
  Y = synthesis_filter_columns(Y,rows/32,columns/32,row_offset,column_offset,h2,g2);
  row_offset = rows/32;
  column_offset = 0;
  Y = synthesis_filter_columns(Y,rows/32,columns/32,row_offset,column_offset,h2,g2);
  ...
  row_offset = 0;
  column_offset = 0;
  Y = synthesis_filter_rows(Y,rows/32,columns/16,row_offset,column_offset,h2,g2);
